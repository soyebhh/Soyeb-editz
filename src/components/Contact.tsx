...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-32 px-6">
      <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-2xl rounded-[50px] p-12 md:p-20 border border-white/10 text-center shadow-2xl">
        ...
        <div className="flex flex-col items-center gap-6">
          <a
            ...
            target="_blank"
            className="group flex items-center gap-6 p-6 rounded-3xl bg-white/5 hover:bg-white/10 hover:shadow-2xl transition-all border border-white/5 hover:border-white/20"
          >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button onClick={copyHandle} className="flex items-center gap-2 px-6 py-3 bg-white/5 text-slate-300 rounded-full font-bold hover:bg-white/10 transition-colors border border-white/5">
